...
@Component({
      ...
      <main class="app-main">
        <section class="router-section">
          ...
          <div class="navigation-demo">
            ...
            <p>Test the dynamic routing by clicking on the site links below:</p>
          ...
          <div class="description-area">
            @if (hoveredSiteDescription()) {
              ...
              <div class="placeholder-description">
                <p>Hover over a site link above to see its description</p>
              </div>
            }
          </div>
        </section>
  ...
  styles: [`
    ...
    .navigation-demo {
      ...
      border-radius: 8px;
      padding: 0.75rem 1rem;
      margin-bottom: 110px; /* Reduced to match smaller description area */
